/*
  ...
  @description the logo for HRMango
*/

import {SvgImage, SvgImagePropTypes} from '../svgImage'

const LogoLightIcon = ({title, width, height, viewBox, dark}: SvgImagePropTypes) => (
    ...
    <g id='HRmango-logo-lightBG' style={{isolation: 'isolate'}}>
      <g id='Grupo_7' data-name='Grupo 7' transform='translate(94.584 18.026)'>
        ...
        <path
          ...
          transform='translate(-288.147 -43.662)'
          fill='#1a1a1a'
        />
        <path
          id='Trazado_18'
          data-name='Trazado 18'
          d='M429.707,52.691a1.232,1.232,0,0,1-.35-.95,3.446,3.446,0,0,1,.28-1.248,4.128,4.128,0,0,0-1.148.665,3.945,3.945,0,0,0-.756.909,4.211,4.211,0,0,1,.644,2.415,3.864,3.864,0,0,1-1.344,3.215,5.532,5.532,0,0,1-3.555,1.072h-.028a7.707,7.707,0,0,0-1.4.95,1.3,1.3,0,0,0-.476.977q0,.869,1.344.868h3.5a5.724,5.724,0,0,1,3.149.8,2.666,2.666,0,0,1,1.246,2.4,3.849,3.849,0,0,1-.868,2.415A5.975,5.975,0,0,1,427.4,68.97a10.844,10.844,0,0,1-4.059.678,10.144,10.144,0,0,1-4.073-.719,2.3,2.3,0,0,1-1.638-2.13,2.071,2.071,0,0,1,.77-1.6,5.363,5.363,0,0,1,2.141-1.058l.168.434a1.747,1.747,0,0,0-.98.76,2.318,2.318,0,0,0-.364,1.275,2.094,2.094,0,0,0,1.162,1.913,6.274,6.274,0,0,0,3.121.665,7.929,7.929,0,0,0,3.695-.8,2.628,2.628,0,0,0,1.54-2.483,1.8,1.8,0,0,0-.714-1.52,4.357,4.357,0,0,0-2.533-.542h-2.071a7.11,7.11,0,0,1-2.645-.407,1.587,1.587,0,0,1-.994-1.628,2.476,2.476,0,0,1,.63-1.6,6.491,6.491,0,0,1,2.085-1.493,4.845,4.845,0,0,1-2.953-1.248,3.936,3.936,0,0,1-1.106-2.985,3.866,3.866,0,0,1,1.344-3.215,5.537,5.537,0,0,1,3.555-1.071,4.959,4.959,0,0,1,3.891,1.411,4.353,4.353,0,0,1,1.344-1.208,3.2,3.2,0,0,1,1.623-.475,1.682,1.682,0,0,1,1.176.407,1.5,1.5,0,0,1,.448,1.167,1.4,1.4,0,0,1-1.4,1.52,1.207,1.207,0,0,1-.854-.326m-4.535,4.735a5.544,5.544,0,0,0,.574-2.944,5.545,5.545,0,0,0-.574-2.944,2.105,2.105,0,0,0-3.387,0,5.546,5.546,0,0,0-.574,2.944,5.545,5.545,0,0,0,.574,2.944,2.105,2.105,0,0,0,3.387,0'
          transform='translate(-306.693 -43.381)'
          fill='#1a1a1a'
        />
        <path
          id='Trazado_19'
          data-name='Trazado 19'
          d='M464.48,52.306q1.749,1.831,1.75,5.549t-1.75,5.535a6.741,6.741,0,0,1-9.209,0q-1.749-1.817-1.749-5.535t1.749-5.549a6.705,6.705,0,0,1,9.209,0m-7.264.38a10.531,10.531,0,0,0-.98,5.169,10.446,10.446,0,0,0,.98,5.155,2.964,2.964,0,0,0,5.318,0,10.446,10.446,0,0,0,.98-5.155,10.531,10.531,0,0,0-.98-5.169,2.953,2.953,0,0,0-5.318,0'
          transform='translate(-324.923 -43.662)'
          fill='#1a1a1a'
        />
      </g>
      <g id='Grupo_8' data-name='Grupo 8'>
        <path
          id='Trazado_1'
          data-name='Trazado 1'
          d='M120.692,17.932a3.917,3.917,0,1,1-3.917-3.917,3.917,3.917,0,0,1,3.917,3.917'
          transform='translate(-57.32 -7.118)'
          fill='#8a8a8a'
        ...
        <path
          id='Trazado_2'
          data-name='Trazado 2'
          d='M144.482,23.89a3.917,3.917,0,1,1-3.917-3.917,3.917,3.917,0,0,1,3.917,3.917'
          transform='translate(-69.402 -10.144)'
          fill='#b1b1b1'
          style={{mixBlendMode: 'luminosity', isolation: 'isolate'}}
        />
        <path
          id='Trazado_3'
          data-name='Trazado 3'
          d='M168.239,37.92A3.917,3.917,0,1,1,164.322,34a3.917,3.917,0,0,1,3.917,3.917'
          transform='translate(-81.468 -17.27)'
          fill='#b1b1b1'
          style={{mixBlendMode: 'luminosity', isolation: 'isolate'}}
        />
        <path
          id='Trazado_4'
          data-name='Trazado 4'
          d='M115.337,33.046a64.853,64.853,0,0,0-7.17,21.092,69.688,69.688,0,0,0-.807,7.268q-.066,1.026-.089,2.037a63.23,63.23,0,0,0-.61,7.264l-.02,2.077A82.548,82.548,0,0,1,103.935,52.4a66.162,66.162,0,0,1,2.8-19.35Z'
          transform='translate(-52.788 -16.784)'
          fill='#8a8a8a'
          style={{mixBlendMode: 'luminosity', isolation: 'isolate'}}
        />
        <path
        ...
        <path
          id='Trazado_6'
          data-name='Trazado 6'
          d='M83.281,9.46a4.73,4.73,0,1,1,4.73-4.73,4.73,4.73,0,0,1-4.73,4.73'
          transform='translate(-39.895)'
          fill='#ff2c1a'
        />
        <path
          id='Trazado_7'
          data-name='Trazado 7'
          d='M47.548,17.932a3.917,3.917,0,1,0,3.917-3.917,3.917,3.917,0,0,0-3.917,3.917'
          transform='translate(-24.149 -7.118)'
          fill='#8a8a8a'
          style={{mixBlendMode: 'luminosity', isolation: 'isolate'}}
        />
        <path
          id='Trazado_8'
          data-name='Trazado 8'
          d='M23.757,23.89a3.917,3.917,0,1,0,3.917-3.917,3.917,3.917,0,0,0-3.917,3.917'
          transform='translate(-12.066 -10.144)'
          fill='#b1b1b1'
          style={{mixBlendMode: 'luminosity', isolation: 'isolate'}}
        />
        <path
          id='Trazado_9'
          data-name='Trazado 9'
          d='M0,37.92A3.917,3.917,0,1,0,3.917,34,3.917,3.917,0,0,0,0,37.92'
        ...
        <path
          ...
          d='M49.221,33.046a64.863,64.863,0,0,1,7.17,21.092,69.815,69.815,0,0,1,.807,7.268q.067,1.026.089,2.037a63.233,63.233,0,0,1,.61,7.264l.02,2.077A82.526,82.526,0,0,0,60.623,52.4a66.163,66.163,0,0,0-2.8-19.35Z'
          transform='translate(-24.999 -16.784)'
          fill='#8a8a8a'
          style={{mixBlendMode: 'luminosity', isolation: 'isolate'}}
        />
        <path
          ...
          d='M8.391,46.827A61.733,61.733,0,0,1,29.95,64.2a69.688,69.688,0,0,1,5.836,8.4c.177.3.35.6.522.9v0c.207.364.413.728.61,1.092.089.162.177.325.261.487,0-.418,0-.832,0-1.255v0c0-.01-.01-.015-.01-.025v0a.041.041,0,0,0,.005-.025c0-.251-.005-.507-.015-.763a63.232,63.232,0,0,0-.61-7.264c-.03-.2-.054-.4-.089-.605A69.361,69.361,0,0,0,34.768,57.1a65.4,65.4,0,0,0-8.814-19.532h0l-8.484,1.5-.251.364a66.36,66.36,0,0,1,11.7,15.4A69.519,69.519,0,0,1,33.591,65.06q-1.092-2.214-2.372-4.409A63.716,63.716,0,0,0,15.29,42.187Z'
          transform='translate(-4.262 -19.079)'
          fill='#b1b1b1'
        />
        <path
          id='Trazado_12'
          data-name='Trazado 12'
          d='M87.895,21.976H80.283l1.6,14.059-2.361,2.751-2.361-2.751,1.6-14.059H71.151a63.273,63.273,0,0,1,4.788,24.8,66.6,66.6,0,0,1-2.485,18.311H85.591a66.6,66.6,0,0,1-2.485-18.311,63.274,63.274,0,0,1,4.788-24.8'
          transform='translate(-36.137 -11.161)'
          fill='#ff2c1a'
        />
      </g>
    </g>
