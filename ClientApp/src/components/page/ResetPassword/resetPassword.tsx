...
import {resetPasswordService} from 'api/authApi'
...
export const ResetPassword = ({match}) => {
  ...
  const userToken = match.params.token.replace(/.*=/, '')
  ...
  const resetPassword = useMutation(
      ...
      }),
    {
      ...
      onError: (error: ErrorMessages) => {
        ...
        dispatch(
          setToast({
            message: `Error updating the new password`,
            type: 'error'
          })
        )
          ...
          >
            <Container>
              ...
              <Box sx={{justifyContent: 'center', display: 'flex', marginRight: 100}}>
                ...
                >
                  <h4 className={classes.forgotPasswordTitle}>Reset Password</h4>
