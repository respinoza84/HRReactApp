...
export const CreationSuccess = ({match}) => {
            ...
            <Container>
              ...
              <Box sx={{justifyContent: 'center', display: 'flex', marginRight: 100}}>
                ...
                >
                  ...
                  <span>
                    Thank you for submitting your request to have a company account with HRmango. Our team will review
                    your request and get in touch with you should we have any questions. You will hear from us within
                    1-2 business days,if not sooner.{' '}
                  </span>
                </Box>
              </Box>
              <Box sx={{py: 2}}>
