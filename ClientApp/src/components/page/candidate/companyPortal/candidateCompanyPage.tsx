...
import {CandidateCompanyTable} from '../../../molecule/candidate/companyPortal/candidateCompanyTable'
import {LocationState} from 'type'

const CandidateCompanyPage = withRouter(
  ({history, location}: RouteComponentProps<{}, StaticContext, LocationState>) => {
    ...
    const addCandidate = () => {
      history.push({
        pathname: `${routes.CompanyCandidateDetail}/`,
        state: {
          header: {
