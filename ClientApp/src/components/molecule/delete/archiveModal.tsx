/*
  @author Randy Diaz
  @description the archiveModal component.
*/
...
const ArchiveModal = ({onRemoveClick, onClose, id, name, open, entityName}: deleteCandidateModalType) => {
  ...
  return (
    <HRModal header={`Archive ${entityName}`} open={open} onClose={onClose}>
      <div className={classes.content}>
        Would you like to Archive the {entityName} {name}?
      </div>
