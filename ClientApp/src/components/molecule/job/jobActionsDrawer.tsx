...
export type JobActionsDrawerType = {
  loaded?: boolean
...
const JobActionsDrawer = withRouter(
  ({
    closeHandler,
    jobId,
    history,
    location
  }: JobActionsDrawerType & RouteComponentProps<{}, StaticContext, LocationState>) => {
    ...
    return (
      <>
        ...
        <NoteModal open={noteModalOpen} onClose={() => setNoteModalOpen(false)} entityId={jobId} entityName='Job' />
      </>
    )
  }
)

export default JobActionsDrawer
